...
export const data = [
    {
        ...
        details: {
            ...
            rules: ["ارائه کارت ملی هوشمند الزامی است.", "ورود حیوانات خانگی، ممنوع است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "مبل", "توالت ایرانی"],
        },
        availability: {
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["برگزاری مهمانی با هماهنگی میزبان، مجاز است.", "استعمال دخانیات داخل اقامتگاه، ممنوع است."],
            ossibilities: ["تلویزیون", "گیرنده دیجیتال", "یخچال", "اجاق گاز", "باربیکیو"],
        },
        availability: {
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، مجاز است.", "استعمال دخانیات داخل اقامتگاه، ممنوع است."],
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ارائه کارت ملی هوشمند الزامی است.", "ورود حیوانات خانگی، ممنوع است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "سرویس غذا خوری", "مبل", "باربیکیو"],
        },
        availability: {
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، ممنوع است.", "استعمال دخانیات داخل اقامتگاه، ممنوع است."],
            ossibilities: ["یخچال", "اجاق گاز", "سرویس غذا خوری", "توالت ایرانی", "دوش"],
        },
        availability: {
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، مجاز است.", "برگزاری مهمانی با هماهنگی میزبان، مجاز است."],
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["استعمال دخانیات داخل اقامتگاه، ممنوع است.", "ورود حیوانات خانگی، مجاز است."],
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، ممنوع است.", "برگزاری مهمانی با هماهنگی میزبان، مجاز است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "سرویس غذا خوری", "توالت ایرانی"],
        },
        availability: {
            availableFrom: "2024-10-01",
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، ممنوع است.", "استعمال دخانیات داخل اقامتگاه، مجاز است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "سرویس غذا خوری", "مبل", "باربیکیو", "جارو برقی"],
        },
        availability: {
            availableFrom: "2024-09-01",
            availableTo: null,
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["استعمال دخانیات داخل اقامتگاه، مجاز است.", "ورود حیوانات خانگی، ممنوع است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "سرویس غذا خوری", "مبل", "باربیکیو"],
        },
        availability: {
            availableFrom: "2024-08-01",
    ...
    },
    {
        ...
        details: {
            ...
            rules: ["ورود حیوانات خانگی، ممنوع است.", "برگزاری مهمانی با هماهنگی میزبان، مجاز است."],
            ossibilities: ["تلویزیون", "یخچال", "اجاق گاز", "سرویس غذا خوری", "باربیکیو", "دوش"],
        },
        availability: {
            availableFrom: "2024-08-15",
            availableTo: "2024-12-31",
